...
useEffect(() => {
  ...
  return (
    ...
    <Grid item xs={12}>    <Posts buyNowData={currentPosts(buyNowData)} loading={loading}></Posts></Grid>
    ...
    <Pagination postsPerPage={postsPerPage} totalPosts={buyNowData.length} paginate={setCurrentPage}></Pagination>
    </Container>
