import { Button, Typography, Grid, Box, TextField, MenuItem, Select, InputLabel, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from "@mui/material";
  ...
  if (data) {
    if (data.data.length > 0) {
      ...
      for (let i = 0; i < data.data.length; i++) {
        ...
        auctionNowData[i].s3 = `https://const123.s3.ap-northeast-2.amazonaws.com/image/${data.data[i].CID}.jpg`;
      }
    }
  }
                    ...
                    >
                      <IconLeft>
                        <CardContent sx={{ flexGrow: 0 }}>
                          <Typography>
                            {" "}
                            <ProfileImg src={"https://img.marieclairekorea.com/2022/02/mck_620f69c1deca3-scaled.jpg"} alt="하트" /> {a.Music.artist}
                          </Typography>
                        </CardContent>
                      </IconLeft>
                      <CardMedia
