              ...
              <Grid item xs={3}>
                ...
                <Box>
                  <div className="menuBar">
                    <Ul className="tabs">
                      <li className={`${menu === 0 ? "active" : ""}`} onClick={() => changeMenu(0)}>
                        나의전체NFT
                      </li>
                      <li className={`${menu === 1 ? "active" : ""}`} onClick={() => changeMenu(1)}>
                        판매중인 나의 NFT
                      </li>
                      <li className={`${menu === 2 ? "active" : ""}`} onClick={() => changeMenu(2)}>
                        경매중인 나의 NFT
                      </li>
                      <li className={`${menu === 3 ? "active" : ""}`} onClick={() => changeMenu(3)}>
                        내 음원 수익
                      </li>
                      <li className={`${menu === 4 ? "active" : ""}`} onClick={() => changeMenu(4)}>
                        음원정보
                      </li>
                    </Ul>
                  </div>
